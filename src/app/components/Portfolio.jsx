...
const projectsData = [
  {
    ...
    feature1:
      "In this project I have used React, Node.js, Express.js, MongoDB, and Bootstrap.",
    feature2: "Feature 2",
    feature3: "Feature 3",
  ...
  },
  {
    ...
    description:
      "This is Full Stack Project created using MERN Stack and Socket.IO",
    feature1: "Feature 1",
    feature2: "Feature 2",
    feature3: "Feature 3",
    ...
    <>
      ...
      {projectsData.map((project, index) =>
        index % 2 === 0 ? (
          ...
          <section key={index} className="text-white mt-20 project-section">
            <div className="container mx-auto px-4">
