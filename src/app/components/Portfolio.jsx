        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-flow-row-dense grid-cols-1 md:grid-cols-2">
            ...
            <div className="col-span-1 mt-4 md:mt-0">
              <div className="card">
                <h3 className="text-2xl font-bold text-white mb-3">Homify</h3>
                <p>ddddddddddddddd</p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-flow-row-dense gap-4 grid-cols-1 md:grid-cols-2">
            <div className="col-span-1 order-2 md:order-1 md:ml-36">
              <div className="card">
                <h3 className="text-2xl font-bold text-white mb-2">ThinkInk</h3>
                <p>ddddddd</p>
                <ul className="list-disc ml-5">
                  <li>ffff</li>
                  <li>ffff</li>
      ...
      <section className="text-white project-section mt-20 ">
        <div className="container mx-auto px-4">
          <div className="grid grid-flow-row-dense grid-cols-1 md:grid-cols-2">
            ...
            <div className="col-span-1 mt-4 md:mt-0">
              <div className="card">
                <h3 className="text-2xl font-bold text-white mb-3">Blog Website</h3>
                <p>ddddddddddddddd</p>
                <ul className="list-disc ml-5">
                  <li>ffff</li>
                  <li>ffff</li>
      ...
      <section className="text-white mt-20 project-section">
        <div className="container mx-auto px-4">
          <div className="grid grid-flow-row-dense gap-4 grid-cols-1 md:grid-cols-2">
            <div className="col-span-1 order-2 md:order-1 md:ml-36">
              <div className="card">
                <h3 className="text-2xl font-bold text-white mb-2">Weather App</h3>
                <p>ddddddd</p>
                <ul className="list-disc ml-5">
                  <li>ffff</li>
                  <li>ffff</li>
